...
public enum Stats implements Stat {
    ...
    HG_HIGHEST_KILL_STREAK("hg_highest_kill_streak", "0", true),
    HG_WINS("hg_wins", "0", true),
    HG_DEATHS("hg_deaths", "0", true),
    HG_MUTANT_KILLS("hg_mutant_kills", "0", true),
    HG_MUTANT_DEATHS("hg_mutant_deaths", "0", true),
    HG_DEATHMATCHES("hg_deathmatches", "0", true),
    ...
    HG_WINSTREAK("hg_winstreak", "0", true),
